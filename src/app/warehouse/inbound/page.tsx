          ...
          <div className="flex-1">
            <Card className="mb-6">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-6">新入库单</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {/* 照片上传 */}
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-3">照片上传</label>
                    <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center">
                      <Upload className="h-12 w-12 text-slate-400 mx-auto mb-3" />
                      <p className="text-sm text-slate-500 mb-2">点击或拖拽文件到此处上传</p>
                      <p className="text-xs text-slate-400">支持 JPG、PNG、PDF 格式，最大 10MB</p>
